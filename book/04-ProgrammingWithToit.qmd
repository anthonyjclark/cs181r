...
We are using the [Toit programming language](https://toitlang.org/). Please read through [their instructions for getting started](https://docs.toit.io/language). You will need to have another group review your code before you are allowed to upload it.

You should start with a "Hello Toit" program that blinks an LED, and then move onto controlling your motors.
